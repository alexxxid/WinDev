 ...
 *  * @UniqueEntity(
 *               fields={"mail"},
 *               message="il existe déja un genre avec le mail {{ value }}, veillez saisir un autre mail "
 * )
 */
class Adherent implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Pret", mappedBy="adherant")
     */
    private $prets;
